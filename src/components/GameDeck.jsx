...
const GameDeck = ({ categoryTotals = {} }) => {
  ...
  return (
    <div className="game-deck">
      <section className="game-deck__card" aria-labelledby={diceLabelId}>
        <button
          type="button"
        ...
        <p id={diceLabelId} className="game-deck__label">
      ...
      <section className="game-deck__card" aria-labelledby={sliderLabelId}>
        <div className="game-deck__slider-header">
          <label id={sliderLabelId} className="game-deck__label" htmlFor={sliderInputId}>
        ...
        <div className="game-deck__slider-track">
          <input
            id={sliderInputId}
            type="range"
            min="-100"
      ...
      <section className="game-deck__card" aria-labelledby={dropdownLabelId}>
        <label id={dropdownLabelId} className="game-deck__label" htmlFor={dropdownSelectId}>
        ...
        <div className="game-deck__total" role="status" aria-live="polite" aria-labelledby={totalLabelId}>
          <span id={totalLabelId}>{t("game_deck_total_label")}</span>
          <span className="game-deck__total-value">{categoryTotalValue}</span>
        </div>
      </section>
    </div>
  );
